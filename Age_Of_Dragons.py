...
# s1 = Soldier('Lama',100,50,['Life Poition'],"gold armor",'blade')
# w1 = Wizard('Ali',45,30,['Life Poition','Health Potion'],['Damage Protection','Damage Increaser','Fire Spell','Fire Protection'])
# dragon.deal_damage_soldier(100,s1)
# w1.health
# print(s1.health)
